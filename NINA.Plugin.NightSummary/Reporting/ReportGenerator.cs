...
namespace NINA.Plugin.NightSummary.Reporting {
    ...
    public class ReportGenerator {
            ...
            try {
                ...
                try {
                    ...
                    foreach (var tt in tsProgress) {
                        ...
                        if (pvShowMinAlt && tt.MinimumAltitude > 0 && tt.MinimumAltitude < 90.0
                            && !pvMinAltLookup.ContainsKey(tt.TargetName))
                            pvMinAltLookup[tt.TargetName] = tt.MinimumAltitude;
                    }
                } catch (Exception ex) {
                ...
                var altChart = BuildPreviewAltitudeChart(targets, colorMap, coordLookup, pvMinAltLookup,
        ...
        private string BuildPreviewAltitudeChart(
            ...
            Dictionary<string, double> minAltLookup,
        ...
        private string BuildSessionAltitudeChart(ReportData data) {
            ...
            // Look up per-target minimum altitude from Target Scheduler data
            ...
            if (showMinAlt && data.TsData != null) {
                foreach (var tsT in data.TsData) {
                    if (tsT.MinimumAltitude > 0 && tsT.MinimumAltitude < 90.0)
                        minAltLookup[tsT.TargetName] = tsT.MinimumAltitude;
                }
            }
