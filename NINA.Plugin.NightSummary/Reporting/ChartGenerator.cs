...
namespace NINA.Plugin.NightSummary.Reporting {
    ...
    public static class ChartGenerator {
        ...
        public const int PrimaryStarCount    = 3;   // Image Quality
        public const int PrimaryEccentricity = 4;
        public const int PrimaryAltitude     = 5;   // Pointing
        public const int PrimaryAirmass      = 6;
        public const int PrimaryFocuserTemp  = 7;   // Temperature
        public const int PrimaryAmbientTemp  = 8;
        public const int PrimaryFocuserPos   = 9;   // Equipment
        public const int PrimaryCameraTemp   = 10;  // Temperature
        public const int PrimaryCoolerSet    = 11;
        public const int PrimaryHumidity     = 12;  // Weather
        public const int PrimaryDewPoint     = 13;
        public const int PrimarySkyQuality   = 14;  // Sky Conditions
        public const int PrimaryCloudCover   = 15;
        public const int PrimarySkyTemp      = 16;
        public const int PrimaryMedian       = 17;  // Image Statistics
        public const int PrimaryMeanADU      = 18;
        public const int PrimaryWindSpeed    = 19;  // Weather
        public const int PrimaryWindGust     = 20;
        public const int PrimaryPressure     = 21;
        public const int PrimarySeeingFWHM   = 22;  // Sky Conditions
        public const int PrimaryStDev        = 23;  // Image Statistics
        public const int PrimaryMAD          = 24;
        public const int PrimaryExposure     = 25;  // Capture Settings
        public const int PrimaryGain         = 26;
        public const int PrimaryAzimuth      = 27;  // Pointing
        public const int PrimaryWindDir      = 28;  // Weather
        public const int PrimarySkyBright    = 29;  // Sky Conditions
        public const int PrimaryRotatorPos   = 30;  // Equipment
        public const int PrimaryPosAngle     = 31;  // Pointing
        public const int PrimaryOffset       = 32;  // Capture Settings
        public const int PrimaryMinADU       = 33;  // Image Statistics
        ...
        public const int SecStarCount    = 4;
        public const int SecEccentricity = 5;
        public const int SecAltitude     = 6;
        public const int SecAirmass      = 7;
        public const int SecFocuserTemp  = 8;
        public const int SecAmbientTemp  = 9;
        public const int SecFocuserPos   = 10;
        public const int SecCameraTemp   = 11;
        public const int SecCoolerSet    = 12;
        public const int SecHumidity     = 13;
        public const int SecDewPoint     = 14;
        public const int SecSkyQuality   = 15;
        public const int SecCloudCover   = 16;
        public const int SecSkyTemp      = 17;
        public const int SecMedian       = 18;
        public const int SecMeanADU      = 19;
        public const int SecWindSpeed    = 20;
        public const int SecWindGust     = 21;
        public const int SecPressure     = 22;
        public const int SecSeeingFWHM   = 23;
        public const int SecStDev        = 24;
        public const int SecMAD          = 25;
        public const int SecExposure     = 26;
        public const int SecGain         = 27;
        public const int SecAzimuth      = 28;
        public const int SecWindDir      = 29;
        public const int SecSkyBright    = 30;
        public const int SecRotatorPos   = 31;
        public const int SecPosAngle     = 32;
        public const int SecOffset       = 33;
