...
namespace $pluginnamespace$.$pluginclassname$Drivers {
    ...
    /// </summary>
    public class $pluginclassname$WeatherDriver : BaseINPC, IWeatherData {
         public $pluginclassname$WeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"$pluginclassname$ Weather Data ({deviceId})";
