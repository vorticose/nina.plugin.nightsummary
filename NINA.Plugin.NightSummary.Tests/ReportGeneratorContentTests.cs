...
namespace NINA.Plugin.NightSummary.Tests {
    ...
    public class ReportGeneratorContentTests {
        ...
        [Fact]
        public async Task Footer_UsesPluginVersion_NotDashboardAssemblyDefault() {
            var data   = TestDataFactory.MakeReportData(imageCount: 5);
            var report = await _generator.GenerateHtmlReport(data);
            Assert.Contains("Generated by Night Summary vtest", report);
            Assert.DoesNotContain("Night Summary v1.0.0", report);
        }
