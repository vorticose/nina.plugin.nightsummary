...
## V1.1 — Report Refinements (Complete)
- Guiding RMS converted to arcseconds using NINA's scale factor
- Star count CV per target split by broadband and narrowband
- Updated column ordering to Min | Max | Mean | CV throughout
- Removed equipment section
- CV footnote added to report
...
- Database schema migration system to preserve data across plugin updates
...
git add ROADMAP.md
git commit -m "Update roadmap - mark V1.1 complete, add DB migration to V2, remove rejected image tracking"
git push
