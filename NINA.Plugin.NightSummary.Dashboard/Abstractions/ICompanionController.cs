...
public interface ICompanionController {
    ...
    // Regenerate-on-primary proxy was removed once the companion gained its
    // own local IReportRegenerator (CompanionReportRegenerator). The companion
    // now regenerates entirely from synced data — no primary contact needed.
}
