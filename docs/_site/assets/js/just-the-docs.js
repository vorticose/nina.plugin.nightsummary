...
function initSearch() {
  ...
  request.open('GET', '/nina.plugin.nightsummary/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/nina.plugin.nightsummary/assets/css/just-the-docs-' + theme + '.css');
}
